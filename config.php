...
$CFG['systemPath'] = dirname(__FILE__)."/"; // the current path of the system ( php files )
...
$CFG['whatsappDir']=$CFG['systemPath']."currentWhatsapp/"; // the FULL PATH to the whatsapp dir
$CFG['whatsappBackupDir']=$CFG['systemPath']."whatsappBackups/"; // the FULL PATH to the backups dir ( if you are going to import with the system )
...
$CFG['tempPath']= $CFG['systemPath']."tempMedia/"; //path to the contact photos
...
$CFG['customSuPath']="auto"; // if not false set the path
...
$CFG['chownUser']="auto"; //user << see who owns the whatsapp files in the phone: ls -l /data/data/com.whatsapp/
$CFG['chownGroup']="auto"; //group
